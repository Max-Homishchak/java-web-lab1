...
import static com.example.spacecatsmarket.util.ProductTestUtil.buildProductEntryDto;
...
class OrderControllerIT extends AbstractIt {
    ...
    private static OrderEntryDto builOrderEntryDto() {
        ProductEntryDto product = buildProductEntryDto();
        return OrderEntryDto.builder().product(product).quantity(1).build();
    }
